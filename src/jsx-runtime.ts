...
export function jsx(type: string, props: any, ...children: any[]): HTMLElement {
  ...
  if (props?.children !== undefined) {
    ...
    finalChildren = Array.isArray(props.children) ? props.children : [props.children]
